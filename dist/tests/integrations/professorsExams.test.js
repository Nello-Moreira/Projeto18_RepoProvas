...
describe('Tests for get /professors/:id', () => {
    ...
    it('should return status code 200 and an array of exams', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should return status code 400 for invalid subject id', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(server_1.default)
    ...
    it('should return status code 204 when there are no exams', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(server_1.default)
            .get(route.replace(':id', `${teacher.id}`))
            .set('authorization', `Bearer ${session.token}`);
