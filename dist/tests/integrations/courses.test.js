...
describe('Tests for get /courses', () => {
    ...
    it('should return status code 204 when there are no courses', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(server_1.default).get(route).set('authorization', `Bearer ${session.token}`);
