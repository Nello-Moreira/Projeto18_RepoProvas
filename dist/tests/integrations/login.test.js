...
describe('Tests for post /login', () => {
    ...
    it('should return status code 404 when there is no user', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should return status code 404 when the password is incorrect', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(server_1.default).post(route).send({
            email: user.email,
            password: 'incorrect',
        });
    ...
    it('should return status code 200 and a token when login is successful', () => __awaiter(void 0, void 0, void 0, function* () {
        const response = yield (0, supertest_1.default)(server_1.default).post(route).send({
            email: user.email,
            password: user.password,
        });
        const inserted = yield (0, typeorm_1.getRepository)(Session_1.default).find({ userId: user.id });
